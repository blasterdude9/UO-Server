...
//Changed stats bonus on items so it can't give negative stats to the players: 22/05/2013 - Giel
...
namespace Server.Items
{
	public abstract class BaseArmor : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability
	{
		...
		public virtual double ArmorRating
		{
			get
			{
				...
				switch ( m_Resource )
				{
					...
					case CraftResource.Rusty:			ar += 16; break;
					case CraftResource.Silver:			ar += 16; break;
					case CraftResource.PureCopper:		ar += 16; break;
					case CraftResource.BronzeAlloy:		ar += 16; break;
					case CraftResource.Shadow:			ar += 16; break;
					case CraftResource.Rose:			ar += 16; break;
					case CraftResource.Lime:			ar += 16; break;
					case CraftResource.Fuscia:			ar += 16; break;
					case CraftResource.Bloodrock:		ar += 16; break;
					case CraftResource.ChromeBlue:		ar += 16; break;
					case CraftResource.ChromeCopper:	ar += 16; break;
					case CraftResource.Pansy:			ar += 16; break;
					case CraftResource.Stinger:			ar += 16; break;
					case CraftResource.Royal:			ar += 16; break;
					case CraftResource.BlueSteel:		ar += 16; break;
					case CraftResource.Ice:				ar += 16; break;
					case CraftResource.Lemon:			ar += 16; break;
					case CraftResource.Blackrock:		ar += 16; break;
					case CraftResource.RoseQuartz:		ar += 16; break;
					case CraftResource.Mint:			ar += 16; break;
					case CraftResource.Aqua:			ar += 16; break;
					case CraftResource.Daemon:			ar += 16; break;
					case CraftResource.Mythril:			ar += 16; break;
					case CraftResource.Titanium:		ar += 16; break;
					case CraftResource.Kryptonite:		ar += 16; break;
					case CraftResource.Diamond:			ar += 16; break;
					case CraftResource.Jolt:			ar += 16; break;
					case CraftResource.Uranium:			ar += 16; break;
					case CraftResource.Opiate:			ar += 16; break;
					case CraftResource.Negative:		ar += 16; break;
					case CraftResource.Deus:			ar += 16; break;
					case CraftResource.DarkDeus:		ar += 16; break;
		...
		public override void AddNameProperty( ObjectPropertyList list )
		{
			...
			else
			{
				switch ( m_Resource )
				{
					...
					case CraftResource.Valorite:		oreType = "Valoreit"; break; // valorite
					//custom ores
					case CraftResource.Rusty:			oreType = "Rusty";	break; // Rusty
					case CraftResource.Silver:			oreType = "Silver";	break; // Silver
					case CraftResource.PureCopper:		oreType = "Pure Copper";	break; // PureCopper
					case CraftResource.BronzeAlloy:		oreType = "Bronze Alloy";	break; // BronzeAlloy
					case CraftResource.Shadow:			oreType = "Shadow";	break; // Shadow
					case CraftResource.Rose:			oreType = "Rose";	break; // Rose
					case CraftResource.Lime:			oreType = "Lime";	break; // Lime
					case CraftResource.Fuscia:			oreType = "Fuscia";	break; // Fuscia
					case CraftResource.Bloodrock:		oreType = "Bloodrock";	break; // Bloodrock
					case CraftResource.ChromeBlue:		oreType = "Chrome Blue";	break; // ChromeBlue
					case CraftResource.ChromeCopper:	oreType = "Chrome Copper";	break; // ChromeCopper
					case CraftResource.Pansy:			oreType = "Pansy";	break; // Pansy
					case CraftResource.Stinger:			oreType = "Stinger";	break; // Stinger
					case CraftResource.Royal:			oreType = "Royal";	break; // Royal
					case CraftResource.BlueSteel:		oreType = "Blue Steel";	break; // BlueSteel
					case CraftResource.Ice:				oreType = "Ice";	break; // Ice
					case CraftResource.Lemon:			oreType = "Lemon";	break; // Lemon
					case CraftResource.Blackrock:		oreType = "Blackrock";	break; // Blackrock
					case CraftResource.RoseQuartz:		oreType = "Rose Quartz";	break; // RoseQuartz
					case CraftResource.Mint:			oreType = "Mint";	break; // Mint
					case CraftResource.Aqua:			oreType = "Aqua";	break; // Aqua
					case CraftResource.Daemon:			oreType = "Daemon";	break; // Daemon
					case CraftResource.Mythril:			oreType = "Mythril";	break; // Mythril
					case CraftResource.Titanium:		oreType = "Titanium";	break; // Titanium
					case CraftResource.Kryptonite:		oreType = "Kryptonite";	break; // Kryptonite
					case CraftResource.Diamond:			oreType = "Diamond";	break; // Diamond
					case CraftResource.Jolt:			oreType = "Jolt";	break; // Jolt
					case CraftResource.Uranium:			oreType = "Uranium";	break; // Uranium
					case CraftResource.Opiate:			oreType = "Opiate";	break; // Opiate
					case CraftResource.Negative:		oreType = "Negative";	break; // Negative
					case CraftResource.Deus:			oreType = "Deus";	break; // Deus
					case CraftResource.DarkDeus:		oreType = "Dark Deus";	break; // DarkDeus
					//custom ores ends
					...
					case CraftResource.RedScales:		oreType = "Red Scale"; break; // red
					case CraftResource.YellowScales:	oreType = "Yellow Scale"; break; // yellow
					case CraftResource.BlackScales:		oreType = "Black Scale"; break; // black
					case CraftResource.GreenScales:		oreType = "Green Scale"; break; // green
					case CraftResource.WhiteScales:		oreType = "White Scale"; break; // white
					case CraftResource.BlueScales:		oreType = "Blue Scale"; break; // blue
		...
		public override void OnSingleClick( Mobile from )
		{
			...
			this.LabelTo( from, "made of " + this.Resource.ToString() + "" );   //shows made of

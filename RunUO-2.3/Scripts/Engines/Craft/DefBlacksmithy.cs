	...
	public class DefBlacksmithy : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			*/
			...
			#region Ingot Crafting
			index = AddCraft( typeof( BronzeAlloyIngot ),  "Craft Ignots", "Bronze Alloy Ignot", 92, 142.0, typeof( RustyIngot ), "Rusty Ingots", 1, 1042081 );
			AddRes( index, typeof ( BronzeIngot ),   1042687, 1, 1042081 );
			
			index = AddCraft( typeof( DarkDeusIngot ),  "Craft Ignots", "DarkDeus Ignot", 100, 100.0, typeof( DeusIngot ), "Deus Ingots", 1, 1042081 );
			AddRes( index, typeof ( ShadowIngot ),   "Shadow Ingots", 1, 1042081 );
			#endregion
			...
			AddSubRes( typeof( IronIngot ),			1044022, 20.0, 1044036, 1044267 );
			AddSubRes( typeof( DullCopperIngot ),	1044023, 65.0, 1044036, 1044268 );
			AddSubRes( typeof( ShadowIronIngot ),	1044024, 70.0, 1044036, 1044268 );
			AddSubRes( typeof( CopperIngot ),		1044025, 40.0, 1044036, 1044268 );
			AddSubRes( typeof( BronzeIngot ),		1044026, 50.0, 1044036, 1044268 );
			AddSubRes( typeof( GoldIngot ),			1044027, 85.0, 1044036, 1044268 );
			AddSubRes( typeof( AgapiteIngot ),		1044028, 74.0, 1044036, 1044268 );
			AddSubRes( typeof( VeriteIngot ),		1044029, 84.0, 1044036, 1044268 );
			AddSubRes( typeof( ValoriteIngot ),		1044030, 94.0, 1044036, 1044268 );
			AddSubRes( typeof( RustyIngot ),		"RUSTY", 00.0, 1044036 );
			AddSubRes( typeof( SilverIngot ),		"SILVER", 55.0, 1044036 );
			AddSubRes( typeof( PureCopperIngot ),	"PURE COPPER", 60.0, 1044036 );
			AddSubRes( typeof( BronzeAlloyIngot ),	"BRONZE ALLOY", 60.0, 1044036 );
			AddSubRes( typeof( ShadowIngot ),		"SHADOW", 65.0, 1044036 );
			AddSubRes( typeof( RoseIngot ),			"ROSE", 70.0, 1044036 );
			AddSubRes( typeof( LimeIngot ),			"LIME", 72.0, 1044036 );
			AddSubRes( typeof( FusciaIngot ),		"FUSCIA", 73.0, 1044036 );
			AddSubRes( typeof( BloodrockIngot ),	"BLOODROCK", 75.0, 1044036 );
			AddSubRes( typeof( ChromeBlueIngot ),	"CHROME BLUE", 76.0, 1044036 );
			AddSubRes( typeof( ChromeCopperIngot ),	"CHROME COPPER", 77.0, 1044036 );
			AddSubRes( typeof( PansyIngot ),		"PANSY", 79.0, 1044036 );
			AddSubRes( typeof( StingerIngot ),		"STINGER", 80.0, 1044036 );
			AddSubRes( typeof( RoyalIngot ),		"ROYAL", 81.0, 1044036 );
			AddSubRes( typeof( BlueSteelIngot ),	"BLUE STEEL", 82.0, 1044036 );
			AddSubRes( typeof( IceIngot ),			"ICE", 82.0, 1044036 );
			AddSubRes( typeof( LemonIngot ),		"LEMON", 83.0, 1044036 );
			AddSubRes( typeof( BlackrockIngot ),	"BLACKROCK", 85.0, 1044036 );
			AddSubRes( typeof( RoseQuartzIngot ),	"ROSE QUARTZ", 86.0, 1044036 );
			AddSubRes( typeof( MintIngot ),			"MINT", 88.0, 1044036 );
			AddSubRes( typeof( AquaIngot ),			"AQUA", 89.0, 1044036 );
			AddSubRes( typeof( DaemonIngot ),		"DAEMON", 89.0, 1044036 );
			AddSubRes( typeof( MythrilIngot ),		"MYTHRIL", 90.0, 1044036 );
			AddSubRes( typeof( TitaniumIngot ),		"TITANIUM", 91.0, 1044036 );
			AddSubRes( typeof( KryptoniteIngot ),	"KRYPTONITE", 93.0, 1044036 );
			AddSubRes( typeof( DiamondIngot ),		"DIAMOND", 95.0, 1044036 );
			AddSubRes( typeof( JoltIngot ),			"JOLT", 96.0, 1044036 );
			AddSubRes( typeof( UraniumIngot ),		"URANIUM", 97.0, 1044036 );
			AddSubRes( typeof( OpiateIngot ),		"OPIATE", 98.0, 1044036 );
			AddSubRes( typeof( NegativeIngot ),		"NEGATIVE", 99.0, 1044036 );
			AddSubRes( typeof( DeusIngot ),			"DEUS", 100.0, 1044036 );
			AddSubRes( typeof( DarkDeusIngot ),		"DARK DEUS", 100.0, 1044036 );

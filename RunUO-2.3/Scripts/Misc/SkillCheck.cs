...
namespace Server.Misc
{
	public class SkillCheck
	{
		...
		public static bool CanLower( Mobile from, Stat stat )
		{
			switch ( stat )
			{
				case Stat.Str: return ( from.StrLock == StatLockType.Down && from.RawStr > 25 );//was 10;
				case Stat.Dex: return ( from.DexLock == StatLockType.Down && from.RawDex > 25 );//was 10;
				case Stat.Int: return ( from.IntLock == StatLockType.Down && from.RawInt > 25 );//was 10;
			}
